...
const Header = () => {
    return (
      <header className="custom:flex bg-[#171414] text-[#FFFFFF] p-4 custom:px-8">
        ...
        <a className="ml-auto inline-flex items-center gap-2 pt-6 custom:pt-0 font-bold text-[#FFFFFF] hover:text-[#5be0e6]" 
